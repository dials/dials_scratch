...
namespace dials { namespace algorithms { namespace boost_python {
    ...
    for (std::size_t i = 0; i < 6; ++i) {
      parameters.push_back(
          boost::python::extract<double>(
            reciprocal_lattice_point_spread[i])());
    }
  ...
  BOOST_PYTHON_MODULE(dials_scratch_jmp_profile_modelling_ext)
  {
    ...
    class_<MosaicBlockAngularSpread>("MosaicBlockAngularSpread", no_init)
      ...
      .def(init<
          ...
          double>((
              ...
              arg("parameter"))))
      .add_property("r",
          &MosaicBlockAngularSpread::get_r)
      .add_property("parameter",
          &MosaicBlockAngularSpread::get_parameter,
          &MosaicBlockAngularSpread::set_parameter)
      .add_property("covariance",
          &MosaicBlockAngularSpread::get_covariance,
    ...
    class_<WavelengthSpread>("WavelengthSpread", no_init)
      ...
      .def(init<
          ...
          double>((
              ...
              arg("parameter"))))
      .add_property("s0",
          &WavelengthSpread::get_s0)
      .add_property("r",
          &WavelengthSpread::get_r)
      .add_property("parameter",
          &WavelengthSpread::get_parameter,
          &WavelengthSpread::set_parameter)
      .add_property("covariance",
          &WavelengthSpread::get_covariance,
    ...
    class_<CovarianceMatrix>("CovarianceMatrix", no_init)
      ...
      .def("num_parameters",
          &CovarianceMatrix::num_parameters)
      .add_property("parameters",
          &CovarianceMatrix::get_parameters,
