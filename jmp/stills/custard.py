...
class Integrator(object):
  ...
  """
    ...
    """
        ...
        print(
            "Discarding %d spots with < %d pixels"
    ...
    """
        ...
        print(
            "Indexed %d strong spots within tolerance %f"
            % (len(self.reflections), self.params.indexing.tolerance)
        )
    ...
    """
        ...
        if self.params.refinement.sample:
            print(
                "Selecting %d/%d reflections for refinement"
                % (self.params.refinement.sample, len(self.reflections))
            )
            selection = flex.size_t(
                sorted(
                    sample(range(len(self.reflections)), self.params.refinement.sample)
                )
            )
            self.reflections = self.reflections.select(selection)
    ...
    """
        ...
        refiner = ProfileRefiner(self.experiment, self.reflections, self.params)
    ...
    """
        ...
        refiner = CrystalRefiner(
            self.experiment, self.reflections, self.mosaicity, self.params
        )
        self.experiment = refiner.experiment
        self.reflections = refiner.reflections
    ...
    """
        ...
        self.reflections.set_flags(
            model.success(), self.reflections.flags.integrated_sum
        )
...
if __name__ == "__main__":
    ...
    print("Min partiality: %f, Max partiality: %f" % (min_partiality, max_partiality))
    print("")
