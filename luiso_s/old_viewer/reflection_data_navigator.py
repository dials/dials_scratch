    ...
    def __call__(self, opt=0):
        ...
        if opt == 0:
            try:
                ...
                title_lst.append(
                    "shoebox_data[" + str(self.z) + ":" + str(self.z + 1) + "]"
                )
            except:
                np_lst.append(None)
            ...
            try:
                ...
                title_lst.append(
                    "shoebox_background[" + str(self.z) + ":" + str(self.z + 1) + "]"
                )
            except:
                np_lst.append(None)
            ...
            try:
                ...
                title_lst.append(
                    "shoebox_mask[" + str(self.z) + ":" + str(self.z + 1) + "]"
                )
            except:
                np_lst.append(None)
                ...
                if z_from >= 0 and z_to <= self.depth:
                    if opt == 1:
                        try:
                            ...
                            title_lst.append(
                                "shoebox_data[" + str(z_from) + ":" + str(z_to) + "]"
                            )
                        except:
                            np_lst.append(None)
                    elif opt == 2:
                        ...
                        try:
                            ...
                            title_lst.append(
                                "shoebox_mask[" + str(z_from) + ":" + str(z_to) + "]"
                            )
                        except:
                            np_lst.append(None)
                    try:
