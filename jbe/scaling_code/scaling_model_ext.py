...
class AimlessScalingModelExt(ScalingModelIface):
  ...
  def factory(cls):
    ...
    from dials_scratch.jbe.scaling_code.ScalingModelFactory import AimlessSMFactory
    return AimlessSMFactory

  @staticmethod
  def from_dict(d):
    '''creates a scaling model from a dict'''
    from dials_scratch.jbe.scaling_code.Model import AimlessScalingModel
...
class KBScalingModelExt(ScalingModelIface):
  ...
  def factory(cls):
    '''returns the scaling Model Factory'''
    from dials_scratch.jbe.scaling_code.ScalingModelFactory import KBSMFactory
    return KBSMFactory

  @staticmethod
  def from_dict(d):
    '''creates a scaling model from a dict'''
    from dials_scratch.jbe.scaling_code.Model import KBScalingModel
...
class XscaleScalingModelExt(ScalingModelIface):
  ...
  def factory(cls):
    '''returns the scaling Model Factory'''
    from dials_scratch.jbe.scaling_code.ScalingModelFactory import XscaleSMFactory
    return XscaleSMFactory

  @staticmethod
  def from_dict(d):
    '''creates a scaling model from a dict'''
    from dials_scratch.jbe.scaling_code.Model import XscaleScalingModel
