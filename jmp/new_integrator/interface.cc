...
make_integration_task_3d_executor(af::reflection_table data,
                                  const af::const_ref<tiny<int, 2>> &jobs,
                                  std::size_t npanels, object callback) {
  return new IntegrationTask3DExecutor(data, jobs, npanels,
...
void export_interface() {
  ...
  class_<IntegrationTask3DExecutor>("IntegrationTask3DExecutor", no_init)
      .def("__init__", make_constructor(&make_integration_task_3d_executor))
  ...
  class_<IntegrationTask3DMultiExecutor>("IntegrationTask3DMultiExecutorBase",
                                         no_init)
      .def(init<af::reflection_table, tiny<int, 2>, std::size_t>())
  ...
  class_<IntegrationManager3DExecutor>("IntegrationManager3DExecutor", no_init)
      .def(init<af::reflection_table, vec2<int>, double>(
          (arg("reflections"), arg("array_range"), arg("block_size"))))
  ...
  class_<IntegrationManager3DMultiExecutor>("IntegrationManager3DMultiExecutor",
                                            no_init)
      .def(init<af::reflection_table, vec2<int>, double>(
          (arg("reflections"), arg("array_range"), arg("block_size"))))
