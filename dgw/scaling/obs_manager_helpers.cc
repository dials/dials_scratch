...
void export_minimum_multiplicity_selection() {
  def("minimum_multiplicity_selection", &minimum_multiplicity_selection,
      (arg("group_index"), arg("multiplicity")));
}
...
void export_grouped_obs() {
  ...
  class_<GroupedObservations>("GroupedObservations", no_init)
      .def(init<af::const_ref<miller_index>, af::shared<double>,
                af::shared<double>, af::shared<double>, af::shared<double>>(
          (arg("group_index"), arg("intensity"), arg("weight"), arg("phi"),
           arg("scale"))))
      ...
      .def("set_weight", &GroupedObservations::set_weight, arg("weight"))
      .def("get_scale", &GroupedObservations::get_scale)
      .def("set_scale", &GroupedObservations::set_scale, arg("scale"))
      ...
      .def("get_average_intensity",
           &GroupedObservations::get_average_intensity);
}
