...
def compute_local_mean_over_variance2(reflections, kernel_size):
  ...
  convolved_N = convolve(N_array.as_double().as_numpy_array(), kernel.as_numpy_array())
...
if __name__ == '__main__':
  ...
  if "intensity.scaled.value" in reflections:
    ...
    reflections['intensity'] = reflections['intensity.scale.value'] / reflections['inverse_scale_factor']
    reflections['variance'] = reflections['intensity.scale.variance'] / reflections['inverse_scale_factor']
  else:
