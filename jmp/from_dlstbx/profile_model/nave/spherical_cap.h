...
public:
  ...
  SphericalCap(vec3<double> axis, double angle)
      : axis_(axis), radius_(axis.length()), angle_(angle) {
   ...
   */
  vec3<double> axis() const { return axis_; }
