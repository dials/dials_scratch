...
from dials.scratch.dgw.refinement import (
...
def random_panel(lim=(0, 50)):
    ...
    return Panel("PAD", u1, u2, o, (lim[1] / 200, lim[1] / 200), (200, 200), (0, 2e20))
