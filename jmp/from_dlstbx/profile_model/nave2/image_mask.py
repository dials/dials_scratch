...
if __name__ == "__main__":
  ...
  """
    ...
    parser = OptionParser(read_experiments=True, phil=phil_scope)
    ...
    assert nimage > 0
    image = [flex.int(flex.grid(panel.get_image_size()[::-1])) for i in range(nimage)]
    ...
    for r in reflections:
        ...
        # Compute the bbox
        bbox = support.compute_bbox(r["panel"], r["s1"], r["xyzcal.mm"][2])
