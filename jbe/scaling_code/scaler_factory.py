...
from dials_scratch.jbe.scaling_code.scaler import MultiScaler, TargetScaler, SingleScalerBase
...
class NullScalerFactory(object):
  ...
  def create(cls, params, experiment, reflection, scaled_id=0):
    """Return Null Scaler."""
    from dials_scratch.jbe.scaling_code.scaler import NullScaler
