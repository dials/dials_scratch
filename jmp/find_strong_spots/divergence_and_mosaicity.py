...
class MaximumLikelihoodEstimator(object):
    ...
    def __init__(self, reflections, sequence):
        ...
        self._optimizer = simplex.simplex_opt(
...
class BeamDivergenceAndMosaicity(object):
    ...
    """
        ...
        Command.end(
            "Calculated e.s.d of the beam divergence = {0:.3f} deg".format(
                sigma_d * 180 / pi
            )
        )
        ...
        Command.end("Calculated mosaicity = {0:.3f} deg".format(sigma_m * 180 / pi))
