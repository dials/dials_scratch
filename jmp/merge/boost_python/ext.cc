...
namespace dials { namespace algorithms { namespace boost_python {
  ...
  vec2<double> truncated_normal_first_and_second_moments(double mu, double sigma) {
    /* double E_p = 0; */
    /* double E_p2 = 0; */
    /* if (mu > 1) { */
    /*   E_p = 1.0; */
    ...
    if (Z > 1e-5) {
      ...
      E_p2 = mu*mu + sigma*sigma - ((mu+1)*e2-(mu+0)*e1)*sigma/Z;
    } else if (mu > 1) {
      E_p = 1.0;
      E_p2 = 1.0;
    } else {
  ...
  vec2<double> compute_E(double rho0, double var_rho0, double mu, double I, double V) {
  ...
  void estimate_partiality(
      af::const_ref<double> I,
      af::const_ref<double> V,
      af::const_ref<double> S,
      af::const_ref<double> M,
      double rho0,
      double var_rho0,
      af::ref<double> E_p,
      af::ref<double> E_p2) {
  ...
  af::shared<double> estimate_intensity(
      af::const_ref<double> I,
      af::const_ref<double> V,
      af::const_ref<double> S,
      af::const_ref<double> E_p,
      af::const_ref<double> E_p2,
      af::ref<double> M,
  ...
  af::shared<double> estimate_scale_factor(
      af::const_ref<double> I,
      af::const_ref<double> V,
      af::const_ref<double> M,
      af::const_ref<double> E_p,
