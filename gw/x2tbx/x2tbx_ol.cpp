...
void ObservationList::add(i_sig_type o) { observations_.push_back(o); }

/**
 * Merge observations - necessary after all reflections loaded.
 */

void ObservationList::merge() {
...
i_sig_type ObservationList::i_sigma() { return i_sig_type(imean_, sigimean_); }
...
float ObservationList::total_i_sigma() { return total_i_sigi_; }
...
size_t ObservationList::multiplicity() { return observations_.size(); }
